<section style="background-color:rgb(204, 216, 227);" class="container-fluid">
<div class="row">
	<div align="center" class="social">
		<div><a href=""><i class="fa-brands fa-facebook fa-2x"></i></a></div>
		<div><a href=""><i class="fa-brands fa-twitter-square fa-2x"></i></a></div>
		<div><a href=""><i class="fa-brands fa-instagram-square fa-2x"></i></a></div>
		<div><a href=""><i class="fa-brands fa-youtube-square fa-2x"></i></a></div>
	</div><!-- <hr style="height: 2px solid grey;"> -->
</div>
<div class="row">
	<div class="secondrow">
	<div class="col1">
...
<div class="row rowthird">
	<p class="text12">Copyright © 2022, Shopeo , All Rights Reserved</p>
</div>
</section>